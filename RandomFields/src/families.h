...
void arcsqrtD(double *x, int *, model *cov, double *v);
void arcsqrtDlog(double *x, int *, model *cov, double *v);
void arcsqrtDinverse(double *v, model *cov, double *left, double *right);
void arcsqrtP(double *x, int *, model *cov, double *v);
void arcsqrtQ(double *x, model *cov, double *v);
void arcsqrtR(double *x, int *, model *cov, double *v);
...
void determD(double *x, int *, model *cov, double *v);
void determDlog(double *x, int *, model *cov, double *v);
void determDinverse(double *v, model *cov, double *left, double *right);
void determP(double *x, int *, model *cov, double *v);
void determP2sided(double *x, double *y,  int *, model *cov, double *v);
void determQ(double *x, model *cov, double *v);
void determR(double *x, int *, model *cov, double *v);
void determR2sided(double *x, double *y, int*, model *cov, double *v);
...
void sphericD(double *x, int *, model *cov, double *v);
void sphericDlog(double *x, int *, model *cov, double *v);
void sphericDinverse(double *v, model *cov, double *left, double *right);
void sphericP(double *x, int *, model *cov, double *v);
void sphericQ(double *x, model *cov, double *v);
void sphericR(double *x, int *, model *cov, double *v);
...
void gaussD(double *x, int *, model *cov, double *v);
void gaussDlog(double *x, int *, model *cov, double *v);
void gaussDinverse(double *v, model *cov, double *left, double *right);
void gaussP(double *x, int *, model *cov, double *v);
void gaussP2sided(double *x, double *y, int *, model *cov, double *v);
void gaussQ(double *x, model *cov, double *v);
void gaussR(double *x, int *, model *cov, double *v);
void gaussR2sided(double *x, double *y, int *, model *cov, double *v);
...
#define LOC_SCALE 1
#define LOC_POWER 2
void locD(double *x, int *, model *cov, double *v);
void locDlog(double *x, int *, model *cov, double *v);
void locDinverse(double *v, model *cov, double *left, double *right);
void locP(double *x, int *, model *cov, double *v);
void locP2sided(double *x, double *y, int *, model *cov, double *v);
void locQ(double *x, model *cov, double *v);
void locR(double *x, int *, model *cov, double *v);
void locR2sided(double *x, double *y, int *, model *cov, double *v);
...
void rectangularD(double *x, int *, model *cov, double *v);
void rectangularDlog(double *x, int *, model *cov, double *v);
void rectangularDinverse(double *v, model *cov, double *left,double *right);
void rectangularP(double *x, int *, model *cov, double *v);
void rectangularP2sided(double *x, double *y, int *, model *cov, double *v);
void rectangularQ(double *x, model *cov, double *v);
void rectangularR(double *x, int *, model *cov, double *v); 
void rectangularR2sided(double *x, double *y, int *, model *cov, double *v); 
...
void setParamD(double *x, int *, model *cov, double *v); 
void setParamDlog(double *x, int *, model *cov, double *v); 
void setParamDinverse(double *v, model *cov, double *left, double *right);
void setParamP(double *x, int *, model *cov, double *v);   
void setParamP2sided(double *x, double *y, int *, model *cov, double *v);   
void setParamQ(double *x, model *cov, double *v);   
void setParamR(double *x, int *, model *cov, double *v);   
void setParamR2sided(double *x, double *y, int *, model *cov, double *v);   
...
void unifD(double *x, int *, model *cov, double *v);
void unifDlog(double *x, int *, model *cov, double *v);
void unifDinverse(double *v, model *cov, double *left, double *right);
void unifP(double *x, int *, model *cov, double *v);
void unifP2sided(double *x, double *y, int *, model *cov, double *v);
void unifQ(double *x, model *cov, double *v);
void unifR(double *x, int *, model *cov, double *v); 
void unifR2sided(double *x, double *y, int *, model *cov, double *v); 
...
void mcmcD(double *x, int *, model *cov, double *v);
void mcmcDlog(double *x, int *, model *cov, double *v);
void mcmcDinverse(double *v, model *cov, double *left,double *right);
void mcmcP(double *x, int *, model *cov, double *v);
void mcmcP2sided(double *x, double *y, int *, model *cov, double *v);
void mcmcQ(double *x, model *cov, double *v);
void mcmcR(double *x, int *, model *cov, double *v); 
void mcmcR2sided(double *x, double *y, int *, model *cov, double *v); 
//void kappa_mcmc(int i, model *cov, int *nr, int *nc);
...
void randomSign(double *x, int *, model *cov, double *v);
void lograndomSign(double *x, int *, model *cov, double *v, double *Sign); 
