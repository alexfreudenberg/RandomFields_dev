...
#define SPEC_TYPES 4
    ...
    isotropy_type
      ...
      iso[SPEC_TYPES] = {max, max,
			 //  SymmetricOf(OWNISO(0)), zwar im Prinzip auch
			 // fuer multivariat korrekt, aber wegen EW nicht
			 // moeglich
			 max,
			 max};
    domain_type
...
void range_specificGauss(model VARIABLE_IS_NOT_USED *cov, int k, int i, int j,
