...
extern int GENERALISEDCAUCHY, STABLE, BROWNIAN, CAUCHY,  GENNSST_INTERN,
  GAUSS, NUGGET, PLUS, MLEPLUS, BALL, MULT, CONST, BIND, PROJ_MODEL,
  DISTRIBUTION,  DETERM_DISTR, GAUSS_DISTR, SETPARAM, SET_DISTR, PROD, ANGLE,
  COVMATRIX, RFGET, COVFCTN, FCTNFCTN,
  LIKELIHOOD_CALL, LINEARPART_CALL, MATRIX,
  PREDICT_CALL, DECLARE,
  ...
  NATSC_USER, NATSC_INTERN, SHAPE_FCT,
...
typedef enum ptwise_type {pt_posdef,
			  pt_indef,
			  pt_negdef, 
