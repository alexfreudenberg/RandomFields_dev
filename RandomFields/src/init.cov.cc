...
void includeCovModels() {
  ...
  // LAPLACE
  kappanames("alpha", REALSXP, "beta", REALSXP, "const", REALSXP);
 ...
 // todo : WARUM HABE ICH DIESES MODELL CODIERT, ABER NICHT ONLINE??     
  ...
  IncludeModelR("constant", PosDefType, 0, 0, 1, kappaconstant, XONLY,
		PREVMODEL_I,
  ...
  //              CE CO CI TBM Sp di sq Ma av n mpp Hy spf any
  IncludeModelR("coxisham",  PosDefType, 1, 1, 3, kappa_cox, 
	       XONLY, SYMMETRIC,
  ...
  */
  ...
  MATRIX=
    IncludeModelR("M",  ManifoldType, 1, MAXSUB, 2, kappaM, PREV_SUB_D,
		 PREV_SUB_I,
  ...
  IncludeScalar("matern", ManifoldType, 0, 0, 2, PARAMDEP_D, PARAMDEP_I,
 ...
 pref_type pfnugget= { 1, 0, 0, 0, 0, 1, 1, 0, 0, 5, 0, 0, 0, 5};
  ...
  IncludeModelR("schur",  PosDefType, 1, 1, 3, kappaSchur, 
	       PREVMODEL_D, PREVMODEL_I, 
 ...
 setptwise(pt_posdef);
  ...
  RandomShape(UNSET, structStp, initOK, doOK,  do_random_failed, 
	      true, false, false);
  ...
  */
  ...
  IncludeScalar("whittle", ManifoldType, 0,0, 2, PARAMDEP_D, PARAMDEP_I,  
